 ...
 * @author hp
 */
public class HomeInPatient extends javax.swing.JFrame {

    /**
     * Creates new form HomeInPatient
     */
    public HomeInPatient() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(1348, 764));
        ...
        jButton2.setText("Ward Allocation");
        ...
        jLabel2.setText("In Patient Management System");

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/InPatientManagementSystem/THE-MOST-COMMON-REASON-PATIENTS-CALL-134100-IN-THE-AFTER-HOURS..png"))); // NOI18N
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        InPatientReport rep = new InPatientReport();
        rep.setVisible(true);
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed

        InPatientWardAllocate war = new InPatientWardAllocate();
        war.setVisible(true);
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed

        InPatientDetails det = new InPatientDetails();
        det.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HomeInPatient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HomeInPatient().setVisible(true);
            }
        });
    }
